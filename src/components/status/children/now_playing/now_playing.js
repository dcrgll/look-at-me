  ...
  return (
    <div className="flex items-center sm:flex-row space-x-2 sm:space-x-2 w-full">
      {data?.songUrl ? (
        ...
        <svg className="h-10 w-10 mx-2 mt-[-2px]" viewBox="0 0 168 168">
          <path
            fill="#1ED760"
...
function AnimatedBars() {
  ...
  return (
    <div className="w-auto flex items-end overflow-hidden">
      <span id="bar1" className="w-1 mr-[3px] h-2 bg-gray-300 opacity-75" />
      <span id="bar2" className="w-1 mr-[3px] h-1 bg-gray-300" />
      <span id="bar3" className="w-1 h-3 bg-gray-300 opacity-80" />
    </div>
  )
}
