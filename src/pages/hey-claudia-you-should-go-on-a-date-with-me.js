      ...
      <Content>
        <Title>
          ...
          <div className="px-2 w-full text-2xl mt-4">
            You should go on a date with me, that&apos;d be pretty <span className='text-red-400'>cool</span> of you.
            <LineBreak />
            <Wave>📦</Wave>
            <Wave>📦</Wave>
            <Wave>📦</Wave>
            ...
            <LineBreak />
            <div className='mt-8'>
              Please find my availability <Link href=''><span className='text-teal-400 cursor-pointer'>here</span></Link>.
            </div>
          </div>
        </Title>
      </Content>
